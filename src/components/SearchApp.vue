<template>
  <section class="App-search">
    <label class="label-search">
      ...
      <input class="App-search-input" type="text" placeholder="Pesquise no Google ou digite um URL" v-model="search" @input="search = $event.target.value">
    </label>
    <button type="button" class='btn clean' :class="{'active': search}" @click="searchClean">
